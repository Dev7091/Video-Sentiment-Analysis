...
model = tf.keras.models.load_model("D:/College Files/Video-Sentiment-Analysis/text_model_lstm.h5")
with open('D:/College Files/Video-Sentiment-Analysis/tokenizer.pickle', 'rb') as handle:
