...
def predict():
    facec = cv2.CascadeClassifier('D:/College Files/Video-Sentiment-Analysis/haarcascade_frontalface_default.xml')
    Category = ["Angry", "Disgust","Fear", "Happy", "Neutral", "Sad","Surprise"]
    #Category = ["Negative", "Neutral","Positive"]
    font = cv2.FONT_HERSHEY_SIMPLEX
    print("Predicting result..")
    model = tf.keras.models.load_model("D:/College Files/Video-Sentiment-Analysis/model.h5")
